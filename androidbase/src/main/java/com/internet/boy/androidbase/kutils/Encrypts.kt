...
import com.internet.boy.androidbase.kutils.deriator.InsecureSHA1PRNGKeyDerivator
 ...
 *
 * 加密/解密相關的擴展函數
 * （相關文章https://zhuanlan.zhihu.com/p/24255780）
 */
...
/*
  在密碼學中，hash算法（散列函數）的作用主要是用於消息摘要和簽名，換句話說，它主要用於對整個消息的完整性進行校驗。
 */
/*
...
  2004年，證實MD5算法無法防止碰撞（collision），因此無法適用於安全性認證，如SSL公開密鑰認證或是數字簽名等用途。
 */
